...
import org.pentaho.reporting.sdk.designtime.gui.model.QueryDialogModelEvent;
import org.pentaho.reporting.sdk.designtime.gui.model.QueryDialogModelListenerAdapter;
...
public abstract class QueryEditorPanel<T> extends JPanel
{
  ...
  private JPanel createQueryListPanel()
  {
    ...
    queryButtons.add(new BorderlessButton(new QueryAddAction<>(dialogModel)));
    queryButtons.add(new BorderlessButton(new QueryRemoveAction<>(dialogModel)));
