...
This will download approximately 120MB of libraries. If you need to use
either the Pentaho-Data-Integration, Mondrian or Olap4J data-sources, you
can use the "sample-use-full" SDK module instead. This will increase the
download size to 120MB.
