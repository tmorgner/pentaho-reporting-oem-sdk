...
public class PentahoEditableDrillDownFunctionTest extends FormulaTestBase
{
  ...
  {
    return new Object[][]{
        {"DRILLDOWN(\"local-editable-analyzer\"; 0; {\"::pentaho-path\" ; \"/public/steel-wheels/test.prpt\" | \"test\" ; \"value\" | \"mtest\" ; {\"v1\"; \"v2\"; \"v3\" }})",
            "http://localhost:8080/pentaho/api/repos/:public:steel-wheels:test.prpt/viewer?test=value&mtest=v1&mtest=v2&mtest=v3"},
        {"DRILLDOWN(\"remote-editable-analyzer\"; \"http://domain.example/\"; {\"::pentaho-path\" ; \"/public/steel-wheels/test.prpt\" | \"test\" ; \"value\" | \"mtest\" ; {\"v1\"; \"v2\"; \"v3\" }})",
